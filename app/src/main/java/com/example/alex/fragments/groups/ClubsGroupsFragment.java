package com.example.alex.fragments.groups;
...
import com.example.alex.fragments.events.ClubsEventsFragment;

/**
 * Created by Alex on 3/5/2016.
 */
public class ClubsGroupsFragment extends Fragment implements View.OnClickListener {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.fragment_clubs_groups, container, false);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.group1Button:
                fragment = new ClubsEventsFragment();
